...
internal class ZoneSettings
{
    ...
    private static bool OnlyCreated = false;
    ...
    internal static void Draw()
    {
        ...
        if(ImGui.BeginCombo("##zSelector", zoneConfigId == 0 ? "Select zone..." : TerritoryName.GetTerritoryName(zoneConfigId)))
        {
            ...
            {
                var col = P.Config.ZoneSettings.ContainsKey(x.RowId);
        ...
        if(P.Config.ZoneSettings.TryGetValue(zoneConfigId, out var zoneSettings))
        {
            ...
            {
                P.Config.ZoneSettings.Remove(zoneConfigId);
        ...
        else
        {
            ...
            {
                P.Config.ZoneSettings.Add(zoneConfigId, new());
                P.ClientState_TerritoryChanged(Svc.ClientState.TerritoryType);
            }
        }
    }
